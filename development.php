...
$query = 'SELECT id, title, project_description, published_date, project_image FROM development';
...
<div class="dev-hero" style="background-image: url(images/dev.jpg); background-size:cover; background-repeat:no-repeat; background-position: center center; ">
      <section class="container" id="hero">
        <h1 class="hidden">Hero Section</h1>
        <h2 id="hero-h2">Web Development</h2>
      </section>
       </div>
      <section class="container-2" id="banner-1">
        <h1 class="hidden">Banner 1</h1>
        <h2>Web development projects I worked on.</h2>
       </section>
