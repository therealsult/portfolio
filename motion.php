...
$query = 'SELECT id, title, project_description, published_date, project_image FROM motion';
...
<div class="motion-hero" style="background-image: url(images/motion.jpg); background-size:cover; background-repeat:no-repeat; background-position: center center; ">
      <section class="container" id="hero">
        <h1 class="hidden">Hero Section</h1>
        <h2 id="hero-h2">Motion Graphics</h2>
      </section>
       </div>
      <section class="container-2" id="banner-1">
        <h1 class="hidden">Banner 1</h1>
        <h2>Video and Motion graphics Design</h2>
       </section>
